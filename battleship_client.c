...
//FOR CLIENT: Compile and input the IP that comes up on when you run the server and then the same port number '7894'
...
void initialize(int *sock, int argcount, char *argv[])
{
